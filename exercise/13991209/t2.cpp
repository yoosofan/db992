...
/*
13991209$ g++ t2.cpp 
t2.cpp: In function ‘void Add_goods()’:
t2.cpp:51:12: warning: format ‘%s’ expects argument of type ‘char*’, but argument 2 has type ‘char (*)[50]’ [-Wformat=]
   51 |   scanf ("%s", &p_t[counter_p].product_name);
      |           ~^   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      |            |   |
      |            |   char (*)[50]
      |            char*
...
t2.cpp:84:12: warning: format ‘%s’ expects argument of type ‘char*’, but argument 2 has type ‘char (*)[50]’ [-Wformat=]
   84 |   scanf ("%s", &c_t[counter_c].name);
      |           ~^   ~~~~~~~~~~~~~~~~~~~~
      |            |   |
      |            |   char (*)[50]
      |            char*
t2.cpp:92:12: warning: format ‘%s’ expects argument of type ‘char*’, but argument 2 has type ‘char (*)[200]’ [-Wformat=]
   92 |   scanf ("%s", &c_t[counter_c].address);
      |           ~^   ~~~~~~~~~~~~~~~~~~~~~~~
      |            |   |
      |            |   char (*)[200]
      |            char*
t2.cpp:96:12: warning: format ‘%s’ expects argument of type ‘char*’, but argument 2 has type ‘char (*)[20]’ [-Wformat=]
   96 |   scanf ("%s", &c_t[counter_c].phone_number);
      |           ~^   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      |            |   |
      |            |   char (*)[20]
      |            char*
